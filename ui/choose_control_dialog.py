...
class ChooseControlDialog(QDialog):
    ...
    def __init__(self, names):
        ...
        self.__allSelect = QPushButton(QCoreApplication.translate("MaxTools", "Select all"))
        self.__allSelect.setMinimumHeight(20)
        self.__allSelect.setMinimumWidth(100)
        self.__deSelect = QPushButton(QCoreApplication.translate("MaxTools", "Unselect"))
        ...
        helpText = '<html><head/><body><p>' + \
                   ...
                   QCoreApplication.translate("MaxTools", "Link on controls description (goeland document)") + \
                   '</span></a></p></body></html>'
