...
class ImportJobsDialog(QDialog):
    ...
    def __init__(self, jobs, selected):
        ...
        if len(self.__jobs) > 0:
            self.__jobButton = QRadioButton(QCoreApplication.translate("MaxTools", "Job(s)"))
        ...
        if self.__selected:
            self.__pointsButton = QRadioButton(QCoreApplication.translate("MaxTools", "Selected Point(s)"))
